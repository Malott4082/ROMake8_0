...
HD_PWD='C:/SharedProjects/ROMake8_0/ROMake8_0.runs/design_1_Byte_Me_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Byte_Me_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Byte_Me_0_0.tcl
